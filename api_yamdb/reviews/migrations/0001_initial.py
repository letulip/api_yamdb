    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.ForeignKey(choices=[(1, 'один'), (2, 'два'), (3, 'три'), (4, 'четыре'), (5, 'пять'), (6, 'шесть'), (7, 'семь'), (8, 'восемь'), (9, 'девять'), (10, 'десять')], default=10, help_text='Оцените произведение', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='reviews', to='reviews.Rating')),
